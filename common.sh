...
function compile_info() {	
	...
	if [[ "${FIRMWARE_TYPE}" == "lxc" ]]; then
		...
		__green_color "wget https://mirror.ghproxy.com/https://raw.githubusercontent.com/stanlyshi/pve/main/openwrt.lxc.sh -O /usr/bin/openwrt && chmod +x /usr/bin/openwrt"
